               ...
               <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $r['nama_req']; ?></td>
                        <td><?= $r['jenis_trans']; ?></td>
                        <td><?= $r['tujuan_trans']; ?></td>
                        <td><?= $r['keperluan_trans']; ?></td>
                        <td><?= $r['req_dari']; ?></td>
                        <td><?= $r['req_ke']; ?></td>
                        <td><?= $r['kode_proyek']; ?></td>
                        <td><font color=blue><?= $r['status_req']; ?></color></td>
                        
                        <td>
                            <a href="<?= base_url('user/editreq/') . $r['id']; ?>" class="badge badge-success">edit</a>
                            <a href="<?= base_url('user/deletereq/') . $r['id']; ?>" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
